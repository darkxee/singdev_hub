(function($) {
    ...
    var mystone = {
        slideindex: function(a,b) {
			a = a || 'li.active-revslide';
            b = b || '#rev_slider_1_1 ul > li';
            return $(a).index(b);
        },
        numslide: function(a) {
			a = a || '#rev_slider_1_1 ul > li';
            return $(a).size();
        },

        btn_bullet_width: function(a) {
			a = a || '.tp-bullets';
            return $(a).width();
        },
        ...
        bullet_move: function(a,b) {
			a = a || this.bullet_lenth();
            b = b || '.overflow-bullet .btn-bullet';
            $(b).animate({
                'left': a
            }, 1000, function() {
                arrow_move();
    ...
    $(document).ready(function() {
        if ($('body.page-id-24').length > 0) {
            ...
            revapi1.bind("revolution.slide.onafterswap", function() {
